...
## ASL Video Content Manifest

The app fetches ASL video content metadata from a CDN-hosted manifest (generated by the
video pipeline).

- Set `EXPO_PUBLIC_CONTENT_MANIFEST_URL` to the published `manifest.json` URL.
