...
export function ASLVideoPlayer({
    ...
    const updateCaption = useCallback((position: number) => {
    ...
    return (
        <View style={styles.wrapper}>
            ...
            <View style={[styles.container, { height, backgroundColor: theme.backgroundSecondary }]}>
                ...
                {currentCaption ? (
                    <View style={[styles.captionOverlay, { backgroundColor: "rgba(0,0,0,0.7)" }]}>
            ...
            {/* English Translation */}
            {englishText && (
                <View style={[styles.translationBar, { backgroundColor: theme.backgroundSecondary }]}>
            ...
            {/* Controls */}
            <View style={[styles.controls, { backgroundColor: theme.backgroundSecondary }]}>
